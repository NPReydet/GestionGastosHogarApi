...
{
    public class ObtenerTopCategoriasIngresoFamiliarHandler
    : IRequestHandler<ObtenerTopCategoriasIngresoFamiliarQuery, IEnumerable<TopCategoriaFamiliarDto>>
    {
        private readonly IRepositorioGruposFamiliares _repositorio;
        private readonly IUsuarioActual _usuarioActual;

        public ObtenerTopCategoriasIngresoFamiliarHandler(IRepositorioGruposFamiliares repositorio, IUsuarioActual usuarioActual)
        {
        ...
        public async Task<IEnumerable<TopCategoriaFamiliarDto>> Handle(
            ObtenerTopCategoriasIngresoFamiliarQuery request, CancellationToken cancellationToken)
        {
            ...
            return await _repositorio.ObtenerTopCategoriasIngresoAsync(
